...
function TransformBackground() {
    ...
    const style = {
        ...
        top: getRandomArbitrary(0,document.documentElement.scrollHeight)+'px',
        background:'linear-gradient(226.25deg, rgba(255, 187, 150, 0.36) -2.27%, rgba(47, 84, 235, 0.36) 100%)',
        mixBlendMode: 'hard-light',
        filter: 'blur(162.359px)',
        transform: 'rotate(-90deg)',
    }
    return (
        <div className="gradient-background" style={style}>
